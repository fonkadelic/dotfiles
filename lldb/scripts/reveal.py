...
def auto_load_reveal(debugger, command, result, dict):
  lldb.debugger.HandleCommand('call (Class)NSClassFromString(@"IBARevealLoader") == nil ? (void *)dlopen("/Applications/Reveal.app/Contents/SharedSupport/iOS-Libraries/libReveal.dylib", 0x2) : ((void*)0)')
